...
const Products = () => {
    ...
    const fetchData = () => {
        axios.get("http://localhost:8080/api/product/addProduct").then((res) => {
        ...
        <div>
            ...
            <table className='table table-hover table-striped table-success'>
                <thead className='table-dark'>
                    <tr>
                        <th>ID</th><th>Name</th><th>Price</th><th>Image</th><th>Quantity</th><th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        product.map((val, index) => {
                            return <tr key={index + 1}>
                                ...
                                <td>
                                    ...
                                    <button type="button" className='btn btn-outline-danger m-1' onClick={() => deleteData(val.id)}>
